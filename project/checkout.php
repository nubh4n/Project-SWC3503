...
<section class="checkout">
   ...
   <form action="" method="post">
      ...
      <div class="flex">
         ...
         <div class="inputBox">
            <span>Unit no.:</span>
            <input type="number" min="0" name="flat" required placeholder="Enter your unit no.">
         </div>
         <div class="inputBox">
            <span>Street:</span>
         ...
         <div class="inputBox">
            <span>Post code :</span>
            <input type="number" min="0" name="pin_code" required placeholder="Enter your post code">
         </div>
      </div>
